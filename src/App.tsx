...
export default function App() {
  ...
  const t = lang === 'pt' ? {
    ...
    explore: 'Foque nos 10 melhores jogos antigos e modernos como Ouri, Senet, Stomachion, Tangram, Jogo de 24, Quadrados Mágicos, Sudoku e Hex. Domine a lógica e matemática de forma interativa!',
    player: 'Jogador',
    ...
    explore: 'Focus on the 10 best ancient and modern games like Ouri, Senet, Stomachion, Tangram, Game of 24, Magic Squares, Sudoku, and Hex. Master logic and math interactively!',
    player: 'Player',
    editName: 'Edit Name',
    tutorial: {
